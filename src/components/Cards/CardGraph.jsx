    ...
    return (
        <div className="h-full flex flex-col bg-slate-50 dark:bg-slate-950">
            ...
            {selectedCardIds.length > 0 ? (
                ...
                <div className="h-20 border-t bg-background/80 backdrop-blur-md flex items-center justify-center gap-4 px-8 sticky bottom-0 z-40">
                    <div className="flex gap-2">
                        <button
                            onClick={() => handleManualCreate('basic')}
                            className="flex items-center gap-2 bg-secondary text-secondary-foreground px-4 py-2.5 rounded-l-full font-medium hover:bg-secondary/80 transition-colors shadow-sm active:scale-95 text-sm border-r border-border"
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-secondary text-secondary-foreground px-4 py-2.5 rounded-r-full font-medium hover:bg-secondary/80 transition-colors shadow-sm active:scale-95 text-sm"
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-[var(--primary-soft)] text-primary px-5 py-2.5 rounded-full font-medium hover:opacity-90 transition-all shadow-md active:scale-95 text-sm mr-auto disabled:opacity-50 disabled:cursor-not-allowed"
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-primary text-primary-foreground px-6 py-2.5 rounded-r-full font-medium hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20 active:scale-95 text-sm"
                        >
                            <Download size={16} />
                            Export
                        </button>
